...
public class Parser
{
   ...
   */
    ...
    */
     ...
     *  Literal 
     */
    private AST.Expression GetExpression()
    {
        return GetAssigmentExpression();
    }


    private AST.Expression GetLogicalExpression()
    {
        return GetGenericExpression(TokenType.LOGICAL_OPERATOR, GetEqualityExpression);
    }

    private AST.Expression GetEqualityExpression()
    {
    ...
    private AST.Expression GetAddativeExpression()
    {
    ...
    private AST.Expression GetMulitplicationExpression()
    {
     ...
     */
    private AST.Expression GetAssigmentExpression()
    {
    ...
    private AST.Expression GetGenericExpression(TokenType tokenType, Func<AST.Expression> finderFunction)
    {
    ...
    */
    private AST.Expression GetPrimaryExpression()
    {
        var token = _tokenIterator.LookUp();
        switch (token.Type)
        {
    ...
    private AST.Expression GetIdentifierExpression()
    {
    ...
    private AST.Expression GetFunctionCall(IdentifierLiteral identifierLiteral)
    {
    ...
    private List<AST.Expression> GetFunctionCallParameters()
    {
     ...
     *  '(' Expression ')'
     */
    private AST.Expression GetParentesisExpression()
    {
        _tokenIterator.NextToken(TokenType.OPEN_ARGUMETNS);
        var expression = GetExpression();
        _tokenIterator.NextToken(TokenType.CLOSE_ARGUMENTS);
